    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Edit Trade Delivery Time</h4>
                    </div>
                </div>
                <br>
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <form action="{{ url('admin/delivery-time/edit') }}" method="post">
                                @csrf
                                <input type="hidden" value="{{$deliveryTime->id}}" name="delivery_id"/>
                                <div class="form-group">
                                    <label>Time (Seconds)</label>
                                    <input class="form-control" type="number" name="delivery_time" placeholder="eg: 120" value="{{$deliveryTime->delivery_time}}">
                                     @error('delivery_time')
